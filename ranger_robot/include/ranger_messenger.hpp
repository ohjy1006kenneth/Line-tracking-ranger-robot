...
namespace westonrobot
{
  ...
  private:
    ...
    void DepthCameraCallback(sensor_msgs::msg::Image::SharedPtr msg);
    void pid_callback(std_msgs::msg::Float64::SharedPtr msg);
    ...
    void detect_callback(std_msgs::msg::Bool::SharedPtr msg); // for obstacle subscriber
    ...
    rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr pid_sub_;
    rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr depth_camera_sub_;
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr obstacle_subscriber;
